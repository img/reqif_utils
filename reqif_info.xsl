  ...
  <xsl:template match="reqif:REQ-IF">
    <html>
      ...
      <title><xsl:value-of select="base-uri()" /></title>
        ...
        SPEC-OBJECTS: <xsl:value-of select="count($specobjects)"/><br/>


        <xsl:variable name="spec-types" select="//reqif:SPEC-TYPES/reqif:SPEC-OBJECT-TYPE"/>
        <table style="border:1px solid black;">
          <tr><td><h1>SPEC-OBJECT-TYPE (<xsl:value-of select="count($spec-types)"/>)</h1></td></tr>
          <tr>
        ...
        <h1>Attribute Definitions with sameAs</h1>
        <table style="border:1px solid black;">
          <tr>
        ...
        <h1>Attribute Types with sameAs</h1>
        <table style="border:1px solid black;">
          <tr>
            <td><b>sameas</b></td><td><b>LONG-NAME</b></td><td><b>id</b></td>
          </tr>
